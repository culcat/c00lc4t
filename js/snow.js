var snowStorm = (function(window, document) {
    ...
    this.flakesMax = 428;           // Limit total amount of snow made (falling + sticking)
    this.flakesMaxActive = 78;      // Limit amount of snow falling at once (less = lower CPU use)
    this.flakesMinActive = 24;      // Try to keep at least X flakes active at all times
    this.flakeScale = 2.0;          // Percentage to scale flakes (1.0 default = normal size)
    ...
    this.flakeWidth = 35;           // Max pixel width reserved for snow element
    this.flakeHeight = 35;          // Max pixel height reserved for snow element
  ...
  */
  ...
  // this.use3DRotate = false;
    ...
    this.webFontCharacters = ['&#127881;']; // characters for webflakes font (EOT/TTF/WOFF)
